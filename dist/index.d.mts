 ...
 */
type ModelType = 'gpt-5.1' | 'gpt-5.1 chat' | 'gpt-5' | 'gpt-5-mini' | 'gpt-5-nano' | 'gpt-4.1-mini' | 'gpt-4.1' | 'gpt-4o-mini' | 'gpt-4o' | 'gpt-o4-mini' | 'gpt-o3' | 'gpt-5.1-codex' | 'gpt-5.1-codex-mini' | 'gpt-5-codex' | 'codex-mini' | 'gemini-3-pro' | 'gemini-2.5-flash-lite' | 'gemini-2.5-flash' | 'gemini-2.0-flash' | 'gemini-2.5-pro' | 'claude-sonnet-4-5' | 'claude-opus-4-5' | 'claude-haiku-4-5' | 'claude-opus-4-1' | 'claude-sonnet-4-0' | 'claude-opus-4-0' | 'llama-4-scout-17b' | 'llama-4-maverick-17b' | 'mistral-small' | 'mistral-medium' | 'mistral-large' | 'magistral-medium' | 'magistral-small' | 'devstral-medium' | 'codestral' | 'qwen-qwq-32b' | 'grok-4-1-fast-non-reasoning' | 'grok-4-fast-reasoning' | 'grok-4-fast-non-reasoning' | 'grok-4' | 'grok-3' | 'grok-3-mini' | 'grok-code-fast' | 'solar-pro2';
/**
